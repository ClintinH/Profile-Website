...
siteInfo.set("ticTacLink", {
  ...
  description: `
    ...
    <div class="slide slide--2">
      <div class="information-block">
        <h5 class="information__header">Lessons learned design / coding</h5>
          <ul class="information__text">
...
siteInfo.set("bankistLink", {
  ...
  description: `
    <div class="slide slide--1">
      <div class="information-block">
        <h5 class="information__header">How to Use!</h5>
            <ul class="information__text">
...
siteInfo.set("bankistWebLink", {
  ...
  description: `
    <div class="slide slide--1">
      <div class="information-block">
        <h5 class="information__header">Marketing Web Page</h5>
            <ul class="information__text">
...
siteInfo.set("forkifyLink", {
  ...
  description: `
    <div class="slide slide--1">
      <div class="information-block">
        <h5 class="information__header">Information Page!</h5>
            <ul class="information__text">
    ...
    <div class="slide slide--2">
      <div class="information-block">
        <h5 class="information__header">How to use!</h5>
            <ul class="information__text">
              <li class="linkstyle">1. Type in search bar recipes you are looking for example pizza</li>
              <li class="linkstyle">2. Find your favorite pizza.</li>
              <li class="linkstyle">3. Change the servings according to number of persons by click on the plus or minus button.</li>
              <li class="linkstyle">4. Click on bookmark to save the recipe for if you would like to use it again.</li>
              <li class="linkstyle">4. Click on the directions button to learn how to cook the recipe.</li>
            </ul>
            ${disclaimer}            
        </div>
    </div>
...
siteInfo.set("maptyLink", {
  ...
  <div class="slide slide--1">
  <div class="information-block">
    <h5 class="information__header">Please note!</h5>
        <ul class="information__text">
          <li class="linkstyle">1. This site requires geolocation best to click on go to webpage button to view</li>
          <li class="linkstyle">2. For more detail about project go to next slide</li>
        </ul>
        ${disclaimer}            
    </div>
</div>
...
siteInfo.set("flappyLink", {
  ...
  description: `
    ...
    <div class="slide slide--3">
      <div class="information-block">
        <h5 class="information__header">Planning</h5>
        <img src="images/flappybirdplanning.svg" alt="" class="planning-image" />        
      </div>
    </div>
  `,
      ...
      <div class="information-block">
        <h5 class="information__header">How to Play!</h5>
            <ul class="information__text">
              ...
              <li class="linkstyle">4. Once the score reaches 0 you will lose the game.</li>
            </ul>
            ${disclaimer}            
        </div>
    </div>
...
siteInfo.set("calculatorLink", {
  ...
  description: `
      ...
      <div class="information-block">
        <h5 class="information__header">How to Use!</h5>
            <ul class="information__text">
              ...
              <li class="linkstyle">4. Use the AC button to reset and start new operation.</li>
            </ul>
    ...
    <div class="slide slide--3">
      <div class="information-block">
        <h5 class="information__header">Planning</h5>
        <img src="images/calculatorplanning.svg" alt="" class="planning-image" />        
      </div>
    </div>
  `,
  ...
  description: `
    <div class="slide slide--1">
      <div class="information-block">
        <h5 class="information__header">How to Play!</h5>
            <ul class="information__text">
              <li class="linkstyle">1. Each player will be given a change to roll the dice which can land from number 1 to 6.</li>
              <li class="linkstyle">2. Everytime the dice stops the corresponding number it landed on will be added to the players current total exluding the number 1.</li>
              <li class="linkstyle">3. A players has to press the hold button to add the current holding total to their total score. If the player rolls a 1 on the dice then their current total will be reset to an amount of 0 and the players turn swops.</li>
              <li class="linkstyle">4. The first player to reach 100 score wins</li>
              </ul>
              ${disclaimer} 
...
projectLinks.addEventListener("click", function (e) {
  ...
  if (info.link !== "https://mapty-clintin.netlify.app") {
